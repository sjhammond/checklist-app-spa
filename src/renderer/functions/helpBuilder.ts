        ...
        <div id="help-container">
            ...
            <div class='help-topic'>
                ...
                <div class='help-content'>
                    <p>Milestone Deployment Assistant is designed to assist technicians and engineers prepare, install, configure, and otherwise deploy Milestone XProtect VMS ${releaseVersion} systems. The application provides an interactive deployment checklist that references and supplements Milestone manuals, guides, and whitepapers with practical advice and suggestions on how to best deploy XProtect VMS.</p>
                ...
                <div class='help-content'>
                    ...
                    <div id="howto__use-checklist">
                        ...
                        <ul>
                            <li>
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M19 5v14H5V5h14m0-2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2z"/><path d="M0 0h24v24H0z" fill="none"/></svg> 
                                <strong>checkbox</strong>. The assistant records the integrator's name and current date along with the completion.
                            </li>
                            <li>
                                To show or hide additional information about a step, select the step title or 
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/><path d="M0 0h24v24H0z" fill="none"/></svg> 
                                <strong>Show more information</strong>. This also shows details about the step's completion status.
                            </li>
                            <li>
                                To record a note or comment, select 
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0V0z"/><path d="M21.99 4c0-1.1-.89-2-1.99-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h14l4 4-.01-18zM17 11h-4v4h-2v-4H7V9h4V5h2v4h4v2z"/></svg> 
                                <strong>Add note</strong>. The assistant records the integrator's name and current date along with the note.
                            </li>
                            <li>
                       ...
                       <p>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M11.67 3.87L9.9 2.1 0 12l9.9 9.9 1.77-1.77L3.54 12z"/><path fill="none" d="M0 0h24v24H0z"/></svg>
                            <strong>back</strong> on the top ribbon.
                        </p> 
                    </div>
                    <div id="howto__save">
                        <h2 class="howto__header">How do I save my work?</h2>
                        <p>Milestone Deployment Assistant automatically saves your work as you go. No manual saving required.</p>
                    </div>
                    <div id="howto__load">
                    ...
                    <div id="howto__edit-project">
                        ...
                        <p>
                            ...
                            <strong>Edit</strong> for the deployment you want to change. On the deployment checklist, select <strong>Edit details</strong> from the side menu in the Actions list.
                        </p>
                    ...
                    <div id="howto__print">
                        ...
                        <p>
                            ...
                            On the Load deployment screen, select 
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M19 8H5c-1.66 0-3 1.34-3 3v6h4v4h12v-4h4v-6c0-1.66-1.34-3-3-3zm-3 11H8v-5h8v5zm3-7c-.55 0-1-.45-1-1s.45-1 1-1 1 .45 1 1-.45 1-1 1zm-1-9H6v4h12V3z"/><path d="M0 0h24v24H0z" fill="none"/></svg> 
                            <strong>Print</strong>. On the deployment checklist, select <strong>Print view</strong> from the side menu in the Actions list.</p>
                    ...
                    <div id="howto__export">
                        ...
                        <p>
                        To export your deployment in order to share it with other team members that have Milestone Deployment Assistant, select <strong>Export data</strong> from the deployment checklist menu in the Actions list, or select 
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M19 12v7H5v-7H3v7c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-7h-2zm-6 .67l2.59-2.58L17 11.5l-5 5-5-5 1.41-1.41L11 12.67V3h2z"/><path fill="none" d="M0 0h24v24H0z"/></svg> 
                        <strong>Export</strong> for the deployment you want to export on the Load deployment screen.</p> 
                        <p>Once you specify the location you want to save the data, your deployment will be saved as an encrypted Milestone Deployment Data (.mddata) file.</p>
                    </div>
