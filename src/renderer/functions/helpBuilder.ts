                    ...
                    <div id="howto__use-checklist">
                        ...
                        <ul>
                            <li>
                                ...
                                <strong>checkbox</strong>. The intergator name and current date is recorded along with the completion.
                            </li>
                            <li>
                                ...
                                <strong>Show more information</strong>. This will also more details about the step's status.
                            </li>
                            <li>
