...
export const renderCreateDeployment = () => {
    ...
    main.innerHTML = `
        <form id="new-deployment__form">
            ...
            <span class="select-product">Select your XProtect&reg; product (required):</span>
            ...
            <div class="text-field">
                <span>Name your deployment (required):</span>
                <input id="deploymentName" type="text" required minlength="1" maxlength="50" pattern="[a-zA-ZÀ-ÿ- +.,()0-9#!*@&?/']+"/>
            </div>
            <div class="text-field">
                <span>Name the integrator working on this project (required):</span>
                <input id="integratorName" type="text" required minlength="1" maxlength="50" pattern="[a-zA-ZÀ-ÿ- +.,()0-9#!*@&?/']+"/>
            </div>
